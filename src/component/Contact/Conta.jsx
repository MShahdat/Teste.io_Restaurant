    ...
    <div className='max-w-7xl px-4 py-8 mx-auto'>
      <div className=''>
        ...
        <motion.div
          ...
          <div className='h-40 flex px-4 items-center justify-center w-full rounded bg-red-500'>
            <p className='text-xl'>Phone: <span className='text-lg'>+880185374041</span></p>
          </div>

          <div className='h-40 flex px-4 items-center justify-center w-full rounded bg-red-500'>
            <p className='text-xl'>Email: <span className='text-lg'>mdshahdat2504@gmail.com</span></p>
          </div>

          <div className='h-40 flex px-4 items-center justify-center w-full rounded bg-red-500'>
            <p className='text-xl'>Website: <span className='text-lg'>www.website.com</span></p>
          </div>
        ...
        <div className='mt-12 grid grid-cols-1 md:grid-cols-2 gap-4'>
          ...
          viewport={defaultViewport}
            ...
            {
              user ? (
                <button type='submit' className='bg-red-600 w-2/9 text-center text-white font-bold text-lg px-4 rounded mt-2 py-1.5'>Submit</button>
              ):(
                <div onClick={() => {
                  setSignInOpen(true)
                }} className='bg-red-600 w-2/9 text-center text-white font-bold text-lg px-4 rounded mt-2 py-1.5'>Submit</div>
              )
            }
            </form>
          </motion.div>
